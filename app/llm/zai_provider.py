...
class ZaiProvider(OpenAIProvider):
    ...
    def _vendor_adjust(self, extra: dict, *, tools: list[dict] | None = None) -> dict:
        ...
        # on an unknown keyword rather than forwarding it — vendor-specific
        # fields have to travel inside `extra_body`.
        extra["extra_body"] = {**(extra.get("extra_body") or {}), "thinking": _thinking()}
        return extra
